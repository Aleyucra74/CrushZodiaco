<?php
    ...
    $pessoas[] = [
		...
		"idSigno" => 3,
		"masculino" => false,
		"descricao" => "Adora o trabalho. uso de brilhantes. uma pessoa feliz",
		"sonho" => "ganhar o certificado da DH",
		"amiga" => true
    ];
	...
	$horoscopos[] = 'Aproximação de pessoa interessantes. Um romance fora do comum pode começar a qualquer momento, mas não está garantida sua continuidade';
...
<head>
    ...
    <title><?php echo $pessoa['nome'];?> - Aula17</title>
